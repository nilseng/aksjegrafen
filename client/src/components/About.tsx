    ...
    >
      <div className="my-5 rounded">
        ...
        <div className="text-center mt-5 p-4" style={{ ...theme.elevation }}>
          <a
            href="/graph?_id=61229167c79b48b7e3e0bc90"
          ...
          >
            ...
            <div className="d-flex justify-content-center py-4">
              <img
                ...
                src={
                  theme.id === "light" ? telenor_img_light : telenor_img_dark
                }
        ...
        <div className="mt-5 p-4" style={{ ...theme.lowering }}>
          <a
            href="/graph?_id=61229164c79b48b7e3e049a5"
            style={{ textDecoration: "none", color: theme.text }}
          >
        ...
        <div className="mt-5 p-4" style={{ ...theme.elevation }}>
          <a
            href="/graph?_id=61229a9bc79b48b7e30c24c5"
            style={{ textDecoration: "none", color: theme.text }}
          >
            <p className="text-center m-0">
