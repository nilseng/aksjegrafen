...
export const Modal = () => {
  ...
  return (
    <div className="absolute w-full h-full z-50 flex justify-center items-center">
      ...
      <div className="relative w-full sm:w-3/4 max-w-2xl h-1/2 flex justify-center items-center bg-gray-50 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-white dark:border-gray-500 p-2 sm:p-4 m-2 sm:m-0">
